1.Using ASP.NET Web API create REST services
...
2. Using ASP.NET Web API and Entity
...
3.Create console application and demonstrate
the use of all service operations using the
HttpClient class (with both JSON and XML)


I am using .\SQLEXPRESS for the data source of the connection string.
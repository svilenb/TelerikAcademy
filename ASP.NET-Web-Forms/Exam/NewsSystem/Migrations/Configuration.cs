namespace NewsSystem.Migrations
{
    ...
    internal sealed class Configuration : DbMigrationsConfiguration<NewsSystem.Models.ApplicationDbContext>
    {
        public Configuration()
        {
            AutomaticMigrationsEnabled = true;
            AutomaticMigrationDataLossAllowed = true;
            ContextKey = "NewsSystem.Models.ApplicationDbContext";
        }
        ...
        protected override void Seed(NewsSystem.Models.ApplicationDbContext context)
        {
            ...
            Author user = new Author() { UserName = "Anonimous" };
